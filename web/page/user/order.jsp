...
<div class="container">
    <form action="${pageContext.request.contextPath}/DoOrders.do" method="post">
    <hr>
    ...
    <div style="padding:5px;">
        <table class="table table-hover table-condensed">
            ...
            <c:forEach items="${sessionScope.cart}" var="cartmap" varStatus="varstatus">
                <tr id="id${cartmap.value.book.name}">
                    <td>${cartmap.value.book.id}</td>
                    <td>${cartmap.value.book.name}</td>
                    <td>${cartmap.value.book.selling_price}</td>
                    <td><input type="text" name="quantity" value="${cartmap.value.quantity}"></td>
    ...
    <div style="padding:5px;">
        <table class="table table-hover table-condensed">
            ...
            <tr>
                <td><input type="radio" class="radio" checked="" name="concheck" value="${consignees.id}"></td>
                <td>${consignees.id}</td>
    ...
    <button type="button" class="btn btn-default btn-lg btn-block"
            href="${pageContext.request.contextPath}/page/books/detail.jsp">返回</button>
